...
/**
 * GET /api/webhook/whatsapp/queue
 * Lista mensajes pendientes de envio manual.
 */
...
/**
 * POST /api/webhook/whatsapp/queue/:id/send
 * Envia un mensaje pendiente y lo marca como enviado.
 */
