...
router.get('/roles', auth, requireRole('superadmin'), async (req, res) => {
  res.json([
    { id: 'superadmin',   label: 'Superadministrador',  descripcion: 'Acceso total' },
    { id: 'operaciones',  label: 'Operaciones',          descripcion: 'Gestión operativa completa' },
    { id: 'comercial',    label: 'Comercial',            descripcion: 'Leads, reservas y pagos' },
    { id: 'operadora',    label: 'Operadora',            descripcion: 'Portal de operadora' },
    { id: 'transportista',label: 'Transportista',        descripcion: 'Módulo de envíos' },
  ]);
});
