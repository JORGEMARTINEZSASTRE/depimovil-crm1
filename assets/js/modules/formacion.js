...
const EVAL_COACHING_BASICO = {
  id:'coaching-basico',
  titulo:'Test Básico — Coaching de Bienestar y Hábitos Saludables',
  categoria:'General',
  nivel:'Básico',
  minimoAprobacion:10,
  preguntas:[
    {q:'¿Qué es el bienestar integral en el contexto de la estética profesional?',o:['Solo la apariencia física de la clienta','Un estado de equilibrio entre la salud física, emocional y mental que potencia los resultados de los tratamientos estéticos y la calidad de vida de la clienta','Solo la ausencia de enfermedades','El resultado de usar los mejores equipos estéticos'],c:1},
    {q:'¿Por qué los hábitos saludables complementan los tratamientos estéticos?',o:['No tienen ninguna relación con los tratamientos','Los tratamientos estéticos actúan sobre los tejidos pero los hábitos (alimentación, hidratación, descanso, ejercicio) determinan la calidad y durabilidad de los resultados; una clienta con buenos hábitos potencia y mantiene mejor lo que logra en cabina','Solo importa la alimentación, no otros hábitos','Los tratamientos funcionan igual independientemente de los hábitos'],c:1},
    {q:'¿Cuánta agua se recomienda beber diariamente para mantener una piel hidratada?',o:['500 ml es suficiente','Solo cuando se tiene sed','Entre 1.5 y 2 litros diarios como mínimo; la hidratación adecuada mejora la elasticidad, el brillo y la recuperación post-tratamiento','5 litros diarios sin excepción'],c:2},
    {q:'¿Qué relación existe entre el sueño y la salud de la piel?',o:['No tiene ninguna relación','Durante el sueño profundo el cuerpo produce hormona de crecimiento que estimula la regeneración celular; la falta de sueño aumenta el cortisol, degradando colágeno y generando inflamación que se refleja en opacidad, ojeras y envejecimiento acelerado','Solo afecta a personas mayores de 50 años','El sueño solo importa para la energía, no para la piel'],c:1},
    {q:'¿Qué efecto tiene el estrés crónico sobre la piel y los resultados estéticos?',o:['El estrés mejora la circulación y beneficia la piel','El estrés crónico eleva el cortisol, que degrada colágeno, aumenta la inflamación, altera la barrera cutánea y puede desencadenar o empeorar acné, psoriasis y rosácea; reduce significativamente la eficacia y durabilidad de los tratamientos estéticos','El estrés solo afecta el estado de ánimo','El estrés no tiene efectos físicos comprobados sobre la piel'],c:1},
    {q:'¿Cuál es el impacto del tabaco sobre la piel y los tratamientos estéticos?',o:['El tabaco no afecta la piel si se usa con moderación','El tabaco reduce la circulación cutánea, disminuye el oxígeno y nutrientes que llegan a la piel, degrada el colágeno y la elastina, genera radicales libres y enlentece la cicatrización; compromete significativamente los resultados de tratamientos de rejuvenecimiento y colágeno','Solo afecta a los pulmones','El tabaco tiene efecto neutro sobre los tratamientos estéticos'],c:1},
    {q:'¿Qué rol cumple la vitamina C en la salud de la piel y cómo se incorpora habitualmente?',o:['No tiene ningún rol en la piel','Es esencial para la síntesis de colágeno, tiene acción antioxidante que neutraliza radicales libres del sol y el estrés, y reduce la hiperpigmentación; se incorpora a través de frutas y verduras frescas (cítricos, kiwi, pimiento) y suplementos si hay déficit','Solo funciona aplicada de forma tópica','La vitamina C solo beneficia el sistema inmune'],c:1},
    {q:'¿Qué es el sedentarismo y cómo afecta a los resultados de tratamientos corporales?',o:['La falta de descanso adecuado','La falta de actividad física regular; en tratamientos corporales (cavitación, criolipólisis, Emsculpt) el sedentarismo reduce la capacidad del organismo para eliminar los lípidos liberados y puede generar acumulación de nueva grasa, comprometiendo los resultados','El sedentarismo solo afecta a los músculos','No tiene relación con los tratamientos estéticos'],c:1},
    {q:'¿Cuál es la importancia del protector solar como hábito de salud y no solo post-tratamiento?',o:['Solo es necesario en días de playa','Es el hábito anti-envejecimiento más efectivo comprobado científicamente; protege de los rayos UVA (envejecimiento) y UVB (quemaduras), previene manchas y cáncer de piel; su uso diario SPF 50+ potencia cualquier tratamiento estético y debe ser un hábito permanente','Solo importa en verano en Uruguay','El protector solar solo protege del quemado, no del envejecimiento'],c:1},
    {q:'¿Cómo puede una operadora estética orientar a su clienta hacia hábitos más saludables sin invadir su privacidad?',o:['Decirle directamente que tiene malos hábitos','Desde el rol de la atención estética, compartir información útil sobre cómo los hábitos potencian los resultados del tratamiento que está realizando; por ejemplo, al hacer un tratamiento corporal, comentar la importancia de la hidratación; el tono es educativo y no invasivo','Ignorar completamente los hábitos de la clienta','Hacer una dieta estricta obligatoria como parte del protocolo'],c:1},
    {q:'¿Qué es el índice glucémico y por qué es relevante para la piel?',o:['Una medida del nivel de colágeno en la piel','La velocidad con que un alimento eleva la glucosa en sangre; los alimentos de alto índice glucémico (azúcar, harinas refinadas) generan picos de insulina que activan procesos inflamatorios y glicación del colágeno, acelerando el envejecimiento cutáneo; una dieta de bajo índice glucémico favorece la piel','Solo importa para diabéticos','No tiene ninguna relación con la piel o el envejecimiento'],c:1},
    {q:'¿Por qué el alcohol afecta negativamente la piel y los resultados estéticos?',o:['El alcohol en moderación beneficia la piel','El alcohol deshidrata la piel desde adentro, dilata los vasos sanguíneos generando rojeces, agota vitaminas antioxidantes (especialmente vitamina C y del grupo B), altera el sueño reparador y aumenta la inflamación; compromete los resultados de tratamientos de hidratación y rejuvenecimiento','Solo el consumo excesivo afecta, el moderado no','El alcohol solo afecta al hígado, no a la piel'],c:1},
  ],
};
const EVAL_COACHING_INTERMEDIO = {
  id:'coaching-intermedio',
  titulo:'Test Intermedio — Coaching de Bienestar y Hábitos Saludables',
  categoria:'General',
  nivel:'Intermedio',
  minimoAprobacion:10,
  preguntas:[
    {q:'¿Qué es el coaching de bienestar y en qué se diferencia de dar consejos de salud?',o:['Son exactamente lo mismo','El coaching de bienestar acompaña a la persona para que identifique sus propias barreras, establezca sus objetivos y encuentre sus propias soluciones mediante preguntas poderosas y herramientas de cambio; dar consejos impone soluciones desde afuera; la operadora no es médica ni nutricionista pero puede usar principios de coaching para motivar hábitos positivos','El coaching es solo para deportistas de élite','El coaching implica decirle a la clienta qué debe hacer exactamente'],c:1},
    {q:'¿Cómo se aplica el concepto de "pequeños hábitos" (atomic habits) para ayudar a una clienta a mejorar su hidratación?',o:['Exigirle que beba 2 litros desde el primer día','En lugar de objetivos grandes que generan resistencia, proponer cambios mínimos y concretos: agregar un vaso de agua antes de cada comida, llevar una botella al trabajo, reemplazar una gaseosa por agua; los pequeños cambios sostenidos generan transformaciones reales sin abrumar','Darle una planilla estricta con horarios de agua','La hidratación no se puede mejorar con cambios pequeños'],c:1},
    {q:'¿Qué son los radicales libres y cómo se relacionan con el envejecimiento cutáneo?',o:['Moléculas que regeneran el colágeno','Moléculas inestables con electrones desapareados que dañan proteínas, lípidos y ADN celular; su acumulación (estrés oxidativo) acelera el envejecimiento, degrada el colágeno y la elastina y aumenta el riesgo de manchas; los antioxidantes (vitamina C, E, polifenoles) los neutralizan','Son beneficiosos para la piel','Solo afectan a personas con exposición solar intensa'],c:1},
    {q:'¿Cómo impacta la microbiota intestinal en la salud de la piel (eje intestino-piel)?',o:['No existe ninguna conexión entre el intestino y la piel','El equilibrio de la microbiota intestinal regula la inflamación sistémica; una microbiota alterada (disbiosis) puede aumentar la inflamación que se manifiesta en la piel como acné, rosácea, eccema o envejecimiento acelerado; el consumo de probióticos, fibra y una alimentación variada favorece el eje intestino-piel','La microbiota solo afecta la digestión','Solo importa en personas con enfermedad intestinal diagnosticada'],c:1},
    {q:'¿Qué es la glicación del colágeno y cómo se previene?',o:['Un proceso que fortalece el colágeno','La unión del azúcar en sangre con las proteínas de colágeno y elastina que genera AGEs (productos de glicación avanzada), haciéndolas rígidas e incapaces de cumplir su función; se previene reduciendo el consumo de azúcares simples y alimentos ultra-procesados, y manteniendo niveles de glucosa estables','Es un proceso natural beneficioso para la piel','Solo afecta a personas diabéticas'],c:1},
    {q:'¿Cómo se integra el ejercicio físico en un protocolo de bienestar para clientas de tratamientos corporales?',o:['El ejercicio no tiene relación con los tratamientos corporales','El ejercicio de fuerza y cardiovascular mejora la circulación, activa el sistema linfático (potenciando la eliminación post-cavitación o criolipólisis), aumenta el metabolismo basal, mejora la composición corporal y potencia los resultados de cualquier tratamiento corporal; se recomienda al menos 150 minutos semanales de actividad moderada','El ejercicio debe evitarse durante los ciclos de tratamiento','Solo el ejercicio aeróbico intenso tiene beneficios'],c:1},
    {q:'¿Qué técnicas de manejo del estrés tienen evidencia científica y son fácilmente aplicables?',o:['Solo la medicación tiene evidencia real','Respiración diafragmática, mindfulness, meditación guiada, actividad física regular, tiempo en naturaleza y conexión social; todas tienen evidencia de reducir el cortisol y la inflamación sistémica; la operadora puede compartir estas herramientas como parte del cuidado integral de la clienta','El estrés no se puede manejar sin psicólogo','Solo el yoga en un estudio especializado tiene efectos comprobados'],c:1},
    {q:'¿Qué son los ácidos grasos esenciales omega-3 y omega-6 y por qué importan para la piel?',o:['Son grasas que engordan y deben evitarse','Son ácidos grasos que el cuerpo no puede sintetizar y deben obtenerse de la alimentación; el omega-3 (pescado, semillas de chía, nueces) tiene efecto antiinflamatorio y refuerza la barrera cutánea; el balance omega-3/omega-6 es clave para reducir la inflamación cutánea','Solo importan para el sistema cardiovascular','Son suplementos artificiales sin beneficio real'],c:1},
    {q:'¿Cómo se aborda el tema de la imagen corporal con una clienta que manifiesta insatisfacción extrema con su cuerpo?',o:['Darle razón y ofrecerle más tratamientos','Escuchar con empatía sin reforzar la insatisfacción, validar sus sentimientos sin alimentar pensamientos distorsionados, y si la insatisfacción parece desproporcionada o interfiere con su vida diaria, sugerir amablemente apoyo psicológico; la operadora no es terapeuta pero puede ser un puente hacia el bienestar integral','Ignorar el tema y hablar solo del tratamiento','Decirle que su percepción es incorrecta y que está bien'],c:1},
    {q:'¿Qué es el sueño reparador y cuántas horas se recomiendan para adultos?',o:['Cualquier cantidad de sueño es equivalente','Entre 7 y 9 horas de sueño de calidad para adultos; el sueño reparador incluye ciclos de sueño profundo donde se produce hormona de crecimiento, se regula el cortisol, se reparan los tejidos y se consolida la memoria; la privación crónica acelera el envejecimiento y reduce la eficacia de los tratamientos de colágeno','Con 4 horas es suficiente si son de calidad','El sueño solo importa para el rendimiento intelectual'],c:1},
    {q:'¿Cómo puede la operadora uruguaya incorporar el enfoque de bienestar en su comunicación con las clientas sin salirse de su rol?',o:['Diagnosticando enfermedades y recetando tratamientos médicos','Compartiendo información educativa sobre hábitos que potencian los resultados del tratamiento que están realizando; por ejemplo, al hacer drenaje linfático mencionar la importancia de la hidratación y el movimiento; al hacer RF hablar del impacto del sueño en el colágeno; el enfoque de bienestar agrega valor sin invadir competencias médicas o nutricionales','Evitando cualquier mención a temas de salud','Enviando planes de dieta y ejercicio personalizados'],c:1},
    {q:'¿Cuál es la diferencia entre motivación intrínseca y extrínseca en el contexto del cambio de hábitos de salud?',o:['Son exactamente lo mismo','La motivación intrínseca surge de valores y deseos propios (sentirse bien, tener energía, verse bien para uno mismo); la extrínseca depende de factores externos (aprobación de otros, premios, obligaciones); los cambios de hábitos sostenidos a largo plazo se anclan en motivación intrínseca; la operadora puede ayudar a la clienta a identificar su porqué profundo','La motivación extrínseca es siempre más efectiva','La motivación no influye en la adopción de hábitos'],c:1},
  ],
};
const EVAL_COACHING_AVANZADO = {
  id:'coaching-avanzado',
  titulo:'Test Avanzado — Coaching de Bienestar y Hábitos Saludables',
  categoria:'General',
  nivel:'Avanzado',
  minimoAprobacion:10,
  preguntas:[
    {q:'¿Cuál es el modelo transteórico de cambio de Prochaska y DiClemente y cómo se aplica al cambio de hábitos de salud en clientas?',o:['Es un modelo de dieta específico para pérdida de peso','El modelo describe 5 etapas del cambio: precontemplación (no considera cambiar), contemplación (piensa en cambiar), preparación (planifica), acción (implementa) y mantenimiento (sostiene el cambio); comprender en qué etapa está la clienta permite adaptar el tipo de apoyo: no presionar a quien está en precontemplación, acompañar la planificación de quien está en preparación','Es un modelo solo para adicciones','Solo aplica a cambios médicos supervisados'],c:1},
    {q:'¿Cómo se diseña un protocolo de bienestar complementario a un ciclo de tratamientos corporales para una clienta en Uruguay?',o:['No existe un protocolo de bienestar estandarizable','Se diseña evaluando el objetivo de la clienta, sus hábitos actuales y sus recursos; incluye: recomendaciones de hidratación (2L/día), actividad física adaptada (150 min/semana de moderada), pautas de alimentación antiinflamatoria, estrategias de manejo del estrés y sueño adecuado; se presenta como complemento motivador sin reemplazar el asesoramiento médico o nutricional','Solo se recomienda beber agua','El protocolo de bienestar es igual para todas las clientas'],c:1},
    {q:'¿Qué es la neuroplasticidad y por qué es relevante para el coaching de hábitos?',o:['La capacidad del cerebro de crecer en tamaño','La capacidad del cerebro de reorganizar sus conexiones neuronales en respuesta a la experiencia y el aprendizaje; esto fundamenta científicamente que los hábitos pueden cambiar a cualquier edad; la repetición de nuevas conductas (beber agua, moverse, dormir bien) crea nuevas vías neurales que con el tiempo hacen que esas conductas sean más automáticas y menos costosas de mantener','Solo aplica a la rehabilitación neurológica','Los hábitos no pueden cambiarse después de los 30 años'],c:1},
    {q:'¿Cuál es el fundamento científico del efecto del ejercicio de fuerza en la síntesis de colágeno?',o:['El ejercicio de fuerza destruye el colágeno por el estrés mecánico','El ejercicio de fuerza genera tensión mecánica en tejidos conectivos que estimula los fibroblastos a producir colágeno tipo I; además mejora la circulación local aportando más nutrientes a la dermis; combinado con tratamientos de RF o HIFU que también estimulan fibroblastos, el ejercicio potencia la síntesis de colágeno de forma sinérgica','El ejercicio de fuerza no tiene efecto sobre el colágeno','Solo el yoga genera colágeno por la elongación muscular'],c:1},
    {q:'¿Cómo se aborda desde el coaching el fenómeno del "todo o nada" que lleva a las clientas a abandonar sus hábitos?',o:['Exigirles que sean perfectas en sus hábitos','Enseñar la perspectiva del progreso no perfecto: un día sin beber suficiente agua o sin hacer ejercicio no destruye el progreso; la consistencia imperfecta es más efectiva que la perfección intermitente; se trabaja con la clienta para que aprenda a retomar sin culpa después de un desvío','Decirles que si no son constantes el tratamiento no funcionará','El "todo o nada" es una característica de personalidad que no puede cambiarse'],c:1},
    {q:'¿Qué es la inflamación crónica de bajo grado y cómo los hábitos de vida la modulan?',o:['Es una enfermedad que solo trata el médico','Es un estado inflamatorio persistente y subclínico que acelera el envejecimiento, degrada el colágeno, favorece la acumulación de grasa y reduce la eficacia de los tratamientos estéticos; se modula con alimentación antiinflamatoria (omega-3, antioxidantes, bajo índice glucémico), ejercicio regular, sueño adecuado y manejo del estrés; es el punto de unión entre bienestar y estética','Solo la afectan las enfermedades autoinmunes','La inflamación crónica de bajo grado no existe fuera de contextos médicos'],c:1},
    {q:'¿Cómo se usa la entrevista motivacional como herramienta de coaching en una consulta estética?',o:['Se hace una lista de lo que debe mejorar la clienta','La entrevista motivacional usa preguntas abiertas, escucha reflexiva y resumen para ayudar a la clienta a explorar su propia motivación para el cambio; por ejemplo: "¿Qué te llevaría a beber más agua?" en lugar de "deberías tomar más agua"; la clienta descubre sus propias razones, lo que genera mayor compromiso con el cambio','Solo la pueden usar los psicólogos','Se le dice a la clienta exactamente lo que debe cambiar'],c:1},
    {q:'¿Qué evidencia existe sobre el impacto del mindfulness en el cortisol y la salud cutánea?',o:['No existe evidencia científica sobre el mindfulness','Estudios controlados muestran que la práctica regular de mindfulness (8 semanas de MBSR) reduce significativamente los niveles de cortisol, la reactividad del eje HPA y marcadores inflamatorios como la IL-6; la reducción del cortisol tiene impacto directo en la protección del colágeno y la reducción de la inflamación cutánea; es una herramienta de bienestar con base científica sólida','El mindfulness solo reduce el estrés subjetivo sin efectos físicos','Solo funciona en personas ya meditadoras previas'],c:1},
    {q:'¿Cómo se integra el concepto de ritmo circadiano en las recomendaciones de bienestar para potenciar tratamientos de rejuvenecimiento?',o:['El ritmo circadiano no tiene relación con la piel','El ritmo circadiano regula la regeneración celular, la producción de melatonina (antioxidante potente), la síntesis de colágeno (pico en las primeras horas de sueño) y la renovación epidérmica (mayor de noche); alinear los hábitos de sueño con el ritmo circadiano (dormir antes de las 23h, evitar pantallas antes de dormir) maximiza la regeneración natural y potencia tratamientos de colágeno','El ritmo circadiano solo afecta el nivel de energía diurno','Solo importa para personas con trabajo nocturno'],c:1},
    {q:'¿Cuál es la diferencia entre asesoramiento nutricional y educación alimentaria en el contexto de la operadora estética?',o:['Son exactamente lo mismo y cualquiera puede hacer ambos','El asesoramiento nutricional implica prescripción de dietas y tratamiento de condiciones médicas; es competencia exclusiva de nutricionistas y médicos; la educación alimentaria es compartir información general sobre cómo ciertos alimentos impactan en la piel y potencian los tratamientos (antioxidantes, hidratación, antiinflamatorios); la operadora puede hacer educación alimentaria pero debe derivar el asesoramiento nutricional especializado','La operadora puede hacer ambos sin restricciones','La operadora no debe mencionar ningún tema relacionado con alimentación'],c:1},
    {q:'¿Cómo se diseña un plan de seguimiento de bienestar a largo plazo para una clienta frecuente en Uruguay?',o:['No es posible hacer seguimiento de bienestar en un negocio estético','Se establece en la primera sesión: objetivos de bienestar de la clienta (hidratación, sueño, estrés), métricas simples de seguimiento (cuánto agua bebe, cómo duerme, nivel de estrés percibido), revisión en cada sesión de cómo van esos hábitos, celebración de logros y ajuste de estrategias; integrado naturalmente en la conversación de la sesión, genera un vínculo de acompañamiento que diferencia a la operadora y fideliza a largo plazo','El seguimiento de bienestar es solo responsabilidad del médico','Solo se puede hacer seguimiento de los tratamientos estéticos'],c:1},
    {q:'¿Qué distingue a una operadora con certificación en coaching de bienestar de una sin esta formación?',o:['Solo conocer recetas de alimentación saludable','Comprende la conexión científica entre hábitos y resultados estéticos, usa herramientas de coaching (preguntas motivacionales, pequeños hábitos, etapas de cambio) para acompañar a su clienta de forma efectiva, conoce sus límites profesionales y deriva cuando corresponde, integra el bienestar en cada sesión de forma natural y convierte cada tratamiento en una experiencia de cuidado integral que fideliza y diferencia su servicio en Uruguay','Tener conocimientos de medicina y nutrición','Decirle a la clienta qué dieta y ejercicio hacer'],c:1},
  ],
};
const EVALUACIONES_TECNICAS = [EVAL_APARATOLOGIA_BASICO, EVAL_APARATOLOGIA_INTERMEDIO, EVAL_APARATOLOGIA_AVANZADO, EVAL_SKINCARE_BASICO, EVAL_SKINCARE_INTERMEDIO, EVAL_SKINCARE_AVANZADO, EVAL_ATENCION_BASICO, EVAL_ATENCION_INTERMEDIO, EVAL_ATENCION_AVANZADO, EVAL_GESTION_BASICO, EVAL_GESTION_INTERMEDIO, EVAL_GESTION_AVANZADO, EVAL_COACHING_BASICO, EVAL_COACHING_INTERMEDIO, EVAL_COACHING_AVANZADO, EVAL_BIOSEGURIDAD_BASICO, EVAL_BIOSEGURIDAD_INTERMEDIO, EVAL_BIOSEGURIDAD_AVANZADO, EVAL_MASAJES_BASICO, EVAL_MASAJES_INTERMEDIO, EVAL_MASAJES_AVANZADO, EVAL_LASER_BASICO, EVAL_LASER_INTERMEDIO, EVAL_LASER_AVANZADO, EVAL_NDYAG_BASICO, EVAL_NDYAG_INTERMEDIO, EVAL_NDYAG_AVANZADO, EVAL_SOPRANO_BASICO, EVAL_SOPRANO_INTERMEDIO, EVAL_SOPRANO_AVANZADO, EVAL_CAVITACION_BASICO, EVAL_CAVITACION_AVANZADO, EVAL_CRIOLIPOLISIS_BASICO, EVAL_CRIOLIPOLISIS_INTERMEDIO, EVAL_CRIOLIPOLISIS_AVANZADO, EVAL_RF_BASICO, EVAL_RF_INTERMEDIO, EVAL_RF_AVANZADO, EVAL_EXILIS_BASICO, EVAL_EXILIS_INTERMEDIO, EVAL_EXILIS_AVANZADO, EVAL_EMSCULPT_BASICO, EVAL_EMSCULPT_INTERMEDIO, EVAL_EMSCULPT_AVANZADO, EVAL_HYDRAFACIAL_BASICO, EVAL_HYDRAFACIAL_AVANZADO, EVAL_BRONCEADO_BASICO, EVAL_BRONCEADO_AVANZADO, EVAL_PRESOTERAPIA, EVAL_HIFU_BASICO, EVAL_HIFU_INTERMEDIO, EVAL_HIFU_AVANZADO];
const CERT_NIVELES = [
  {
    id:'nivel-1',
    titulo:'Nivel 1',
