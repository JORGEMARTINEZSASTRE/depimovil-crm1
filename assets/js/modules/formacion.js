...
async function saveEvaluacionTecnica(){
  ...
  }else if(aprobada && (esHIFU || esLaser || esNdYAG || esExilis || esEmsculpt || esHydrafacial || esSoprano || esBronceado || esAparatologia || esMasajes || esCavitacion || esSkincare)){
...
function renderEvaluacionesRows(allResultados){
  ...
  const otros = EVALUACIONES_TECNICAS.filter(e => !e.id.startsWith('laser-') && !e.id.startsWith('hifu-') && !e.id.startsWith('ndyag-') && !e.id.startsWith('exilis-') && !e.id.startsWith('emsculpt-') && !e.id.startsWith('hydrafacial-') && !e.id.startsWith('soprano-') && !e.id.startsWith('bronceado-') && !e.id.startsWith('aparatologia-') && !e.id.startsWith('masajes-') && !e.id.startsWith('cavitacion-') && !e.id.startsWith('skincare-'));
